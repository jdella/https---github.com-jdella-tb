...
{
	// THIS CLASS IS THE BEGINNING OF A BINDABLE BACKGROUND SERVICE TO HANDLE LOCATION
	// UPDATES.  WILL SEPERATE THIS CONCERN FROM INDIVIDUAL ACTIVITY CLASSES.
	// MOSTLY COMMENTED OUT TO AVOID BUILD ERRORS/CONFLICTS AS NOT FULLY IMPLEMENTED.
