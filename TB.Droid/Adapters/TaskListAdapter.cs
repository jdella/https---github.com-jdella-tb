...
namespace TaskBuddi.Droid.Adapters
{
	...
	public class TaskListAdapter : BaseAdapter<Task>
	{
		...
		public override View GetView(int position, View convertView, ViewGroup parent)
		{
			...
			//TODO - HACK - Multiple click events..
			view.Click += (sender, e) =>
			{
			...
			tv.Text = "TA-DA!!";
			var layout = view.FindViewById<LinearLayout>(Resource.Id.tdLayout);
			layout.AddView(tv);

			//context.FindViewById<ResizingGridView>(Resource.Id.vGroups).AddView(tv);
			//view.FindViewById<ResizingGridView>(Resource.Id.vGroups).AddView(view);

			//context.FindViewById<LinearLayout>(Resource.Id.vLayout).AddView(tv);
			//parent.FindViewById<LinearLayout>(Resource.Id.vLayout).AddView(view);
